...
const projects = [
  { id: 1, title: 'Siège Social Banque Alpha', sector: 'Bureaux', surface: '2500 m²', img: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800', isLarge: true },
  { id: 2, title: 'Hôtel Le Prestige', sector: 'Hôtellerie', surface: '1200 m²', img: 'https://images.unsplash.com/photo-1566665797739-1674de7a421a?auto=format&fit=crop&q=80&w=800', isLarge: false },
  ...
  { id: 4, title: 'Boutique Flagship', sector: 'Commerce', surface: '450 m²', img: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=800', isLarge: false },
  { id: 5, title: 'Université des Sciences', sector: 'Enseignement', surface: '8000 m²', img: 'https://images.unsplash.com/photo-1562774053-701939374585?auto=format&fit=crop&q=80&w=800', isLarge: false },
];
